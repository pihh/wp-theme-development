			...
			<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
				<div class="carousel-inner">
				  <div class="carousel-item active">
					<img src="https://via.placeholder.com/1600x900?text=1" class="d-block w-100" alt="1">
				  </div>
				  <div class="carousel-item">
					<img src="https://via.placeholder.com/1600x900?text=2" class="d-block w-100" alt="2">
				  </div>
				  <div class="carousel-item">
					<img src="https://via.placeholder.com/1600x900?text=3" class="d-block w-100" alt="3">
				  </div>
				</div>
